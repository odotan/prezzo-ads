#import "PREPrezzoPrezzologoaloneView.h"

@interface PREPrezzoPrezzologoaloneView () 
...
@implementation PREPrezzoPrezzologoaloneView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"PREPrezzoPrezzologoalone.png";
