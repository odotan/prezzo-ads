...
@interface PREMeViewController ()
- (void)backgroundClicked:(id)sender;
@property (nonatomic) PREMeBackgroundShapeView *elemBackgroundShape;
@property (nonatomic) UIButton *elemButton;
@property (nonatomic) PREMePrezzologofullringView *elemPrezzologofullring;
@property (nonatomic) CGSize visibleKeyboardSize;
@property (nonatomic) CGPoint originalScrollContentOffset;
@end

@interface PREMe_TappableBackgroundView : UIView
@property (nonatomic, weak) PREMeViewController *viewController;
@end

@implementation PREMe_TappableBackgroundView
...
@implementation PREMeViewController
...
- (void)loadView
{
    ...
    PREMe_TappableBackgroundView *rootView = [[PREMe_TappableBackgroundView alloc] initWithFrame:CGRectMake(0, 0, screenSize.width, screenSize.height)];
    ...
    PREMeBackgroundShapeView *elemBackgroundShape = [[PREMeBackgroundShapeView alloc] initWithFrame:CGRectMake(0.0, 0.0, 320.0, 568.0)];
    ...
    elemButton.frame = CGRectMake(37.5, 185.0, 113.2, 34.0);
    ...
    PREMePrezzologofullringView *elemPrezzologofullring = [[PREMePrezzologofullringView alloc] initWithFrame:CGRectMake(37.5, 32.5, 243.0, 109.0)];
    self.elemPrezzologofullring = elemPrezzologofullring;

    elemPrezzologofullring.userInteractionEnabled = NO;

    [rootView addSubview:self.elemPrezzologofullring];
...
- (void)repositionElements
{
    ...
    @[@4, [NSValue valueWithCGRect:CGRectMake(38.0, 187.5+yOff, 114.58, 34.38)], [NSValue valueWithCGPoint:CGPointMake(0.0, 167.5)]],  // iphoneclassic_portrait
    @[@6, [NSValue valueWithCGRect:CGRectMake(37.5, 185.0+yOff, 113.21, 33.96)], [NSValue valueWithCGPoint:CGPointMake(0.0, 165.0)]],  // iphone5_portrait
    @[@20, [NSValue valueWithCGRect:CGRectMake(35.67, 175.33+yOff, 107.30, 32.19)], [NSValue valueWithCGPoint:CGPointMake(0.0, 155.33)]],  // iphone6plus_portrait
    @[@16, [NSValue valueWithCGRect:CGRectMake(37.0, 184.0+yOff, 112.50, 33.75)], [NSValue valueWithCGPoint:CGPointMake(0.0, 164.0)]],  // ipad_portrait
    @[@18, [NSValue valueWithCGRect:CGRectMake(37.5, 185.0+yOff, 113.07, 33.92)], [NSValue valueWithCGPoint:CGPointMake(0.0, 165.0)]],  // iphone6_portrait
    ];
    ...
    NSArray *layoutDescs_elemPrezzologofullring = @[
    @[@4, [NSValue valueWithCGRect:CGRectMake(38.0, 33.0+yOff, 245.5, 110.5)], [NSValue valueWithCGPoint:CGPointMake(0.0, 13.0)]],  // iphoneclassic_portrait
    @[@6, [NSValue valueWithCGRect:CGRectMake(37.5, 32.5+yOff, 243.0, 109.0)], [NSValue valueWithCGPoint:CGPointMake(0.0, 12.5)]],  // iphone5_portrait
    @[@20, [NSValue valueWithCGRect:CGRectMake(35.33, 31.0+yOff, 230.0, 103.33)], [NSValue valueWithCGPoint:CGPointMake(0.0, 11.0)]],  // iphone6plus_portrait
    @[@16, [NSValue valueWithCGRect:CGRectMake(37.0, 33.0+yOff, 242.0, 109.0)], [NSValue valueWithCGPoint:CGPointMake(0.0, 13.0)]],  // ipad_portrait
    @[@18, [NSValue valueWithCGRect:CGRectMake(37.5, 32.5+yOff, 242.5, 109.0)], [NSValue valueWithCGPoint:CGPointMake(0.0, 12.5)]],  // iphone6_portrait
    ];
    NSDictionary *override_elemPrezzologofullring = [_overrideElementLayoutDescriptors objectForKey:@"prezzo-logo-full-ring"];
    if ((val = [override_elemPrezzologofullring objectForKey:@"layoutDescs"]))
       layoutDescs_elemPrezzologofullring = val;
    NSArray *layoutAssocData_elemPrezzologofullring = @[
      @[@4, @{
        @"contentTransformMatricesString": @"[0.227314815, 0.0, 0.0, 0.227314815, 0.0, -6.125]; [0.227314815, 0.0, 0.0, 0.227314815, 0.0, -6.125]",
      }],
      @[@6, @{
        @"contentTransformMatricesString": @"[0.225, 0.0, 0.0, 0.225, 0.0, -6.250]; [0.225, 0.0, 0.0, 0.225, 0.0, -6.250]",
      }],
      @[@20, @{
        @"contentTransformMatricesString": @"[0.212962963, 0.0, 0.0, 0.212962963, 0.0, -5.833333333]; [0.212962963, 0.0, 0.0, 0.212962963, 0.0, -5.833333333]",
      }],
      @[@16, @{
        @"contentTransformMatricesString": @"[0.224074074, 0.0, 0.0, 0.224074074, 0.0, -6.0]; [0.224074074, 0.0, 0.0, 0.224074074, 0.0, -6.0]",
      }],
      @[@18, @{
        @"contentTransformMatricesString": @"[0.224537037, 0.0, 0.0, 0.224537037, 0.0, -6.125]; [0.224537037, 0.0, 0.0, 0.224537037, 0.0, -6.125]",
      }],
    ];
    if ((val = [override_elemPrezzologofullring objectForKey:@"associatedData"]))
       layoutAssocData_elemPrezzologofullring = val;
    [self applyLayout:layoutDescs_elemPrezzologofullring toView:self.elemPrezzologofullring format:format associatedData:layoutAssocData_elemPrezzologofullring flowIsHorizontal:flowIsHoriz flowPosPtr:&flowPos];
