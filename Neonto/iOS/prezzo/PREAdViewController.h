...
@interface PREAdViewController : UIViewController
...
@interface PREAdViewControllerCollectionCell : UICollectionViewCell

@property (nonatomic) PREAdViewController *containedViewController;

@end


@interface PREAdViewControllerTableCell : UITableViewCell
