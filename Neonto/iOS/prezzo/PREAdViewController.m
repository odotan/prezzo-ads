...
static const CGSize DEFAULT_CONTENT_SIZE = {319.0, 319.0};

@interface PREAdViewController ()
@property (nonatomic) PREAdBackgroundShapeView *elemBackgroundShape;
...
@implementation PREAdViewController
...
- (void)loadView
{
    ...
    PREAdBackgroundShapeView *elemBackgroundShape = [[PREAdBackgroundShapeView alloc] initWithFrame:CGRectMake(0.0, 0.0, 319.0, 319.0)];
...
- (void)repositionElements
{
    ...
    @[@4, [NSValue valueWithCGRect:CGRectMake(0.0, 0.0+yOff, 323.0, 323.0)], [NSValue valueWithCGPoint:CGPointMake(0.0, 0.0)], @{ @"bottomEdgeOffset": @(0.0+yOff) } ],  // iphoneclassic_portrait
    @[@6, [NSValue valueWithCGRect:CGRectMake(0.0, 0.0+yOff, 319.0, 319.0)], [NSValue valueWithCGPoint:CGPointMake(0.0, 0.0)], @{ @"bottomEdgeOffset": @(0.0+yOff) } ],  // iphone5_portrait
    @[@20, [NSValue valueWithCGRect:CGRectMake(0.0, 0.0+yOff, 302.67, 302.67)], [NSValue valueWithCGPoint:CGPointMake(0.0, 0.0)], @{ @"bottomEdgeOffset": @(0.0+yOff) } ],  // iphone6plus_portrait
    @[@16, [NSValue valueWithCGRect:CGRectMake(0.0, 0.0+yOff, 317.0, 317.0)], [NSValue valueWithCGPoint:CGPointMake(0.0, 0.0)], @{ @"bottomEdgeOffset": @(0.0+yOff) } ],  // ipad_portrait
    @[@18, [NSValue valueWithCGRect:CGRectMake(0.0, 0.0+yOff, 319.0, 319.0)], [NSValue valueWithCGPoint:CGPointMake(0.0, 0.0)], @{ @"bottomEdgeOffset": @(0.0+yOff) } ],  // iphone6_portrait
    ];
...
@implementation PREAdViewControllerCollectionCell

- (id)initWithFrame:(CGRect)frame
{
    PREAdViewController *vc = [[PREAdViewController alloc] initWithNibName:nil bundle:nil];
...
@implementation PREAdViewControllerTableCell
