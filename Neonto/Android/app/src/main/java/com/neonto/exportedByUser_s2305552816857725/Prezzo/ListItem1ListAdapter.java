...
public class ListItem1ListAdapter extends BaseAdapter {
    ...
    public ListItem1ListAdapter(Fragment owner) {
        mOwner = owner;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Class viewClass = AdvertiserView.class;
        ...
        layoutDescs.add(new LayoutDesc(10, 0.0f, 0.0f, LayoutDesc.NO_VALUE, 599.0f, 148.0f));  // 720*1280 px
        layoutDescs.add(new LayoutDesc(2, 0.0f, 0.0f, LayoutDesc.NO_VALUE, 261.0f, 64.0f));  // 240*320 px
        layoutDescs.add(new LayoutDesc(12, 0.0f, 0.0f, LayoutDesc.NO_VALUE, 755.0f, 186.0f));  // 1080*1920 px
        layoutDescs.add(new LayoutDesc(8, 0.0f, 0.0f, LayoutDesc.NO_VALUE, 425.0f, 105.0f));  // 480*800 px
        elementDesc.put("layoutDescs", layoutDescs);
        overrides.put("image", elementDesc);
        
        elementDesc = new HashMap();
        layoutDescs = new ArrayList<LayoutDesc>();
        layoutDescs.add(new LayoutDesc(10, 0.0f, 0.0f, 0.0f, 599.0f, 149.0f));  // 720*1280 px
        layoutDescs.add(new LayoutDesc(2, 0.0f, 0.0f, 0.0f, 261.0f, 65.0f));  // 240*320 px
        layoutDescs.add(new LayoutDesc(12, 0.0f, 0.0f, 0.0f, 755.0f, 188.0f));  // 1080*1920 px
        layoutDescs.add(new LayoutDesc(8, 0.0f, 0.0f, 0.0f, 425.0f, 105.0f));  // 480*800 px
        elementDesc.put("layoutDescs", layoutDescs);
