...
public class AdBackgroundShapeView extends View {



    public AdBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public AdBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public AdBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.scale(m_realLayoutWidthInPx/638.0f, m_realLayoutHeightInPx/638.0f);
        canvas.translate(319.0f, 319.0f);
        path = new Path();
        path.moveTo(-319.0f, -319.0f);
          path.lineTo(319.0f, -319.0f);
        path.lineTo(319.0f, 319.0f);
        path.lineTo(-319.0f, 319.0f);
