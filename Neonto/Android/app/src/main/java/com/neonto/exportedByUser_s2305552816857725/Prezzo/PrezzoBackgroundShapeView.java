...
public class PrezzoBackgroundShapeView extends View {



    public PrezzoBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public PrezzoBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public PrezzoBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
