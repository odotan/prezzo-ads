...
public class MeBackgroundShapeView extends View {



    public MeBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public MeBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public MeBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
