...
public class AdvertiserView extends FrameLayout implements AdapterView {

    private AdvertiserBackgroundShapeView mBackgroundShape;
    private AdvertiserImageView mImage;
    ...
    public AdvertiserView(Fragment owner) {
    ...
    public View createView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.view_advertiser, container, false);
                
        mBackgroundShape = (AdvertiserBackgroundShapeView) rootView.findViewById(R.id.mBackgroundShape);
        mImage = (AdvertiserImageView) rootView.findViewById(R.id.mImage);
    ...
    private void repositionElements() {
        ...
        layoutDescs_mImage.add(new LayoutDesc(10, 0.0f, 0.0f, LayoutDesc.NO_VALUE, 599.0f, 148.0f));  // 720*1280 px
        layoutDescs_mImage.add(new LayoutDesc(2, 0.0f, 0.0f, LayoutDesc.NO_VALUE, 260.0f, 64.0f));  // 240*320 px
        layoutDescs_mImage.add(new LayoutDesc(12, 0.0f, 0.0f, LayoutDesc.NO_VALUE, 756.0f, 186.0f));  // 1080*1920 px
        layoutDescs_mImage.add(new LayoutDesc(8, 0.0f, 0.0f, LayoutDesc.NO_VALUE, 425.0f, 105.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        layoutDescs_mImage.get(0).contentTransformMatricesString = "[0.318617021, 0.0, 0.0, 0.318617021, 0.0, -94.548404255]; [0.318617021, 0.0, 0.0, 0.318617021, 0.0, -94.548404255]";
        layoutDescs_mImage.get(1).contentTransformMatricesString = "[0.138297872, 0.0, 0.0, 0.138297872, 0.0, -41.159574468]; [0.138297872, 0.0, 0.0, 0.138297872, 0.0, -41.159574468]";
        layoutDescs_mImage.get(2).contentTransformMatricesString = "[0.402127660, 0.0, 0.0, 0.402127660, 0.0, -119.725531915]; [0.402127660, 0.0, 0.0, 0.402127660, 0.0, -119.725531915]";
        layoutDescs_mImage.get(3).contentTransformMatricesString = "[0.226063830, 0.0, 0.0, 0.226063830, 0.0, -67.087765957]; [0.226063830, 0.0, 0.0, 0.226063830, 0.0, -67.087765957]";
