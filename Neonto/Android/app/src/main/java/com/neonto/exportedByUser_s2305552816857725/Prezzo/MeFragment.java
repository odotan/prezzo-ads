...
public class MeFragment extends Fragment {
    ...
    private MeBackgroundShapeView mBackgroundShape;
    private Button mButton;
    private MePrezzologofullringView mPrezzologofullring;

    public MeFragment() {  // fragment must have a constructor
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBackgroundShape = (MeBackgroundShapeView) rootView.findViewById(R.id.mBackgroundShape);
        mButton = (Button) rootView.findViewById(R.id.mButton);
        mPrezzologofullring = (MePrezzologofullringView) rootView.findViewById(R.id.mPrezzologofullring);
    ...
    private void repositionElements() {
        ...
        layoutDescs_mButton.add(new LayoutDesc(10, 70.0f, 299.0f, LayoutDesc.NO_VALUE, 212.52f, 63.76f));  // 720*1280 px
        layoutDescs_mButton.add(new LayoutDesc(2, 31.0f, 130.0f, LayoutDesc.NO_VALUE, 92.37f, 27.71f));  // 240*320 px
        layoutDescs_mButton.add(new LayoutDesc(12, 89.0f, 378.0f, LayoutDesc.NO_VALUE, 268.05f, 80.41f));  // 1080*1920 px
        layoutDescs_mButton.add(new LayoutDesc(8, 50.0f, 212.0f, LayoutDesc.NO_VALUE, 150.71f, 45.21f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
        ...
        ArrayList<LayoutDesc> layoutDescs_mPrezzologofullring = new ArrayList<LayoutDesc>();
        layoutDescs_mPrezzologofullring.add(new LayoutDesc(10, 70.0f, 13.0f, LayoutDesc.NO_VALUE, 456.0f, 205.0f));  // 720*1280 px
        layoutDescs_mPrezzologofullring.add(new LayoutDesc(2, 31.0f, 6.0f, LayoutDesc.NO_VALUE, 198.0f, 89.0f));  // 240*320 px
        layoutDescs_mPrezzologofullring.add(new LayoutDesc(12, 89.0f, 18.0f, LayoutDesc.NO_VALUE, 575.0f, 258.0f));  // 1080*1920 px
        layoutDescs_mPrezzologofullring.add(new LayoutDesc(8, 50.0f, 10.0f, LayoutDesc.NO_VALUE, 323.0f, 145.0f));  // 480*800 px
        if (mOverrideElementLayoutDescriptors != null) {
            HashMap<String, ArrayList<LayoutDesc>> override_mPrezzologofullring = mOverrideElementLayoutDescriptors.get("prezzologofullring");
            if (override_mPrezzologofullring != null) {
                ArrayList<LayoutDesc> layoutDescs = override_mPrezzologofullring.get("layoutDescs");
                if (layoutDescs != null) {
                    layoutDescs_mPrezzologofullring = layoutDescs;
                }
            }
        }
        layoutDescs_mPrezzologofullring.get(0).contentTransformMatricesString = "[0.422222222, 0.0, 0.0, 0.422222222, 0.0, -11.5]; [0.422222222, 0.0, 0.0, 0.422222222, 0.0, -11.5]";
        layoutDescs_mPrezzologofullring.get(1).contentTransformMatricesString = "[0.183333333, 0.0, 0.0, 0.183333333, 0.0, -5.0]; [0.183333333, 0.0, 0.0, 0.183333333, 0.0, -5.0]";
        layoutDescs_mPrezzologofullring.get(2).contentTransformMatricesString = "[0.532407407, 0.0, 0.0, 0.532407407, 0.0, -14.750]; [0.532407407, 0.0, 0.0, 0.532407407, 0.0, -14.750]";
        layoutDescs_mPrezzologofullring.get(3).contentTransformMatricesString = "[0.299074074, 0.0, 0.0, 0.299074074, 0.0, -8.250]; [0.299074074, 0.0, 0.0, 0.299074074, 0.0, -8.250]";
        applyLayoutToView(mPrezzologofullring, dm, layoutDescs_mPrezzologofullring, true, true);
