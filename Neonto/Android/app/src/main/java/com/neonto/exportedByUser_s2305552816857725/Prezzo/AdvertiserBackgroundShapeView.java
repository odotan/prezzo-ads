...
public class AdvertiserBackgroundShapeView extends View {



    public AdvertiserBackgroundShapeView(Context context) {
        super(context);
        init(null, 0);
    }
    
    public AdvertiserBackgroundShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }
    
    public AdvertiserBackgroundShapeView(Context context, AttributeSet attrs, int defStyle) {
