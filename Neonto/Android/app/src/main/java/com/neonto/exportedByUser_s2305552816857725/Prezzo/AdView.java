...
public class AdView extends FrameLayout implements AdapterView {

    private AdBackgroundShapeView mBackgroundShape;
    ...
    public View createView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.view_ad, container, false);
                
        mBackgroundShape = (AdBackgroundShapeView) rootView.findViewById(R.id.mBackgroundShape);
    ...
    private void repositionElements() {
        ...
        layoutDescs_mBackgroundShape.add(new LayoutDesc(10, 0.0f, 0.0f, 0.0f, 599.0f, 599.0f));  // 720*1280 px
        layoutDescs_mBackgroundShape.add(new LayoutDesc(2, 0.0f, 0.0f, 0.0f, 260.0f, 260.0f));  // 240*320 px
        layoutDescs_mBackgroundShape.add(new LayoutDesc(12, 0.0f, 0.0f, 0.0f, 756.0f, 756.0f));  // 1080*1920 px
        layoutDescs_mBackgroundShape.add(new LayoutDesc(8, 0.0f, 0.0f, 0.0f, 425.0f, 425.0f));  // 480*800 px
